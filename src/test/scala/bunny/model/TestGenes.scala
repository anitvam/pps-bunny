...
import bunny.model.genome.Genes.{ EARS, FUR_COLOR, FUR_LENGTH, GeneKind }
import bunny.model.genome.KindsUtils.{ assignRandomDominance, getGeneKind, resetDominance }
