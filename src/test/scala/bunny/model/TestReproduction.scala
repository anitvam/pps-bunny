...
import bunny.model.Bunny.{ generateRandomFirstBunny, splitBunniesByGene }
import bunny.model.genome.{ Gene, Genes, StandardAllele }
import bunny.model.world.Reproduction.{ combineCouples, generateAllChildren, generateChildren, nextGenerationBunnies }
