...
import bunny.model.Bunny.{ filterBunniesWithAlleles, generateRandomFirstBunny, splitBunniesByGene }
import bunny.model.genome.Genes.GeneKind
import bunny.model.genome.{ Alleles, Genes }
import bunny.model.world.disturbingFactors._
import bunny.model.world.Generation.Population
import bunny.model.world.disturbingFactors.{
