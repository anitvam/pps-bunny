...
object BunnyImage extends Enumeration {
  ...
  val BrownHighEarsLongTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> HIGH_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val BrownHighEarsLongTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> HIGH_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> LONG_FUR))
  )
  ...
  val BrownHighEarsNormalTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> HIGH_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val BrownHighEarsNormalTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> HIGH_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> LONG_FUR))
  )
  ...
  val BrownLongEarsLongTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> LOW_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val BrownLongEarsLongTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> LOW_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> LONG_FUR))
  )
  ...
  val BrownLongEarsNormalTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> LOW_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val BrownLongEarsNormalTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> BROWN_FUR, EARS -> LOW_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> LONG_FUR))
  )
  ...
  val WhiteHighEarsLongTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> HIGH_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val WhiteHighEarsLongTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> HIGH_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> LONG_FUR))
  )
  ...
  val WhiteHighEarsNormalTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> HIGH_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val WhiteHighEarsNormalTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> HIGH_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> LONG_FUR))
  )
  ...
  val WhiteLongEarsLongTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> LOW_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val WhiteLongEarsLongTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> LOW_EARS, TEETH -> LONG_TEETH, FUR_LENGTH -> LONG_FUR))
  )
  ...
  val WhiteLongEarsNormalTeethNormalFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> LOW_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> SHORT_FUR))
  )
  ...
  val WhiteLongEarsNormalTeethThickFur: BunnyImage = BunnyImage(
    ...
    Phenotype(
      Map(FUR_COLOR -> WHITE_FUR, EARS -> LOW_EARS, TEETH -> SHORT_TEETH, FUR_LENGTH -> LONG_FUR))
  )

  case class BunnyImage(normalImage: Image, jumpingImage: Image, phenotype: Phenotype)
      extends super.Val
  ...
  implicit def getBackgroundConfiguration(environment: ClimateImage): Background = new Background(
    Array(
      new BackgroundImage(
        ...
        size = new BackgroundSize(width = 1.0,
                                  height = 1.0,
