...
@sfxml
class MutationsPanelController(@FXML val jumpRecessiveChoiceButton: Button,
                               ...
                               @FXML private val mutationIncomingLabel: Label) extends MutationsPanelControllerInterface {
