...
object GenerationsUtils {
  ...
  case class StartPhase(override val generationNumber: Int,
                        override val phase: Double = START_PHASE)
      extends GenerationPhase

  case class WolvesPhase(override val generationNumber: Int,
  ...
  case class HighTemperaturePhase(override val generationNumber: Int,
