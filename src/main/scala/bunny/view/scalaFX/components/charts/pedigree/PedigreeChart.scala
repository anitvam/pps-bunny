package bunny.view.scalaFX.components.charts.pedigree

import bunny.engine.SimulationConstants.MAX_GENEALOGICAL_TREE_GENERATIONS
import bunny.model.Tree.generateTree
import bunny.model.{ BinaryTree, Bunny, Node }
import scalafx.geometry.Pos
import scalafx.scene.image.ImageView
import scalafx.scene.layout._
import scalafx.scene.text.Text
import bunny.util.PimpScala._
import bunny.view.scalaFX.ScalaFXConstants.GenealogicalTree._
import bunny.view.scalaFX.ScalaFXConstants.{ PREFERRED_CHART_HEIGHT, PREFERRED_CHART_WIDTH }

import scala.language.postfixOps

trait PedigreeChart {

  /** Reference to the bunny.model bunny entity */
  val bunny: Bunny

  /** Reference to the bunny.model tree entity created from the bunny */
  val tree: BinaryTree[Bunny]

  /** The pane with the bunny.view of the tree */
  val chartPane: Pane
}
...
object PedigreeChart {
   ...
   * @return
   *   The bunny.view of a row and the trees which needs to be inserted in the next one
   */
  ...
  /** Creates a bunny.view of the plus between couples of bunnies */
