package bunny.view.scalaFX.components.charts

import bunny.model.genome.Alleles
import bunny.model.genome.Alleles.AlleleKind
import bunny.model.genome.KindsUtils.getGeneKind
...
import bunny.view.scalaFX.components.charts.LineChartComponentFactory.{ createEmptySeries, createXYChartData }
import bunny.view.scalaFX.components.charts.PopulationChartDataType._
import bunny.view.scalaFX.utilities.PimpScalaFXChartLibrary._
...
object PopulationChartDataType {
  ...
  /** A map to manged the [[ChartSeries]] for each [[bunny.model.genome.Alleles.AlleleKind]] */
