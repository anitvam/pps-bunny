...
import bunny.model.genome.Alleles._
import bunny.model.genome.Genes._
import bunny.model.genome.{ Genes, Phenotype }
import scalafx.scene.image.Image
import bunny.view.scalaFX.utilities.ImageType.{ ImageType, Jumping, Normal }
