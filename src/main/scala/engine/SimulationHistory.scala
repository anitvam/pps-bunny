...
object SimulationHistory {
  ...
  def introduceMutation(mutation: Mutation): Unit = {
    getActualGeneration.environment.mutations =
      mutation :: getActualGeneration.environment.mutations
  ...
  def getEnvironmentForNextGeneration: Environment =
   ...
   */
  def changeEnvironmentClimate(climate: Climate): Unit =
    getActualGeneration.environment.climate = climate
