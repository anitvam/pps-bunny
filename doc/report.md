...
La genetica studia il genoma, formato da cromosomi e  geni. Da questi ultimi dipende il patrimonio genetico della prole, composto dagli attributi trasmessi dai genitori.  <br /> Ogni gene riguarda una caratteristica, che nell'ambito della riproduzione dei conigli può essere ad esempio il *colore della pelliccia* o la *forma delle oreccchie*.  Ogni gene è formato da due alleli, questi sono ereditati casualmente dal figlio prendendo una delle possibili combinazioni degli alleli dei genitori. Il [Quadrato di Punnett](https://it.wikipedia.org/wiki/Quadrato_di_Punnett) è uno schema che per una qualsiasi coppia di genitori mostra le quattro combinazioni di alleli possibili per formare il gene del figlio. <br /> Gli alleli possono comparire in due forme, che ad esempio per il *colore della pelliccia* possono essere la *pelliccia bianca* o la *pelliccia bruna*. Una delle due forme è dominante e l'altra recessiva, ciò significa che se compaiono entrambe per un certo gene quella dominante prevarrà e sarà visibile sul figlio e di conseguenza farà parte del suo *fenotipo*.

#### Glossario
* **Gene** - Rappresenta un caratteristica dell'organismo, è composto da due alleli.
