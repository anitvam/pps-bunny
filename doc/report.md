...
Il processo di sviluppo adottato mette in partica le metologie previste dalla programmazione Agile, in particolare alcuni aspetti del framework **Scrum**:
...
* Ogni coniglietto vive per 4 generazioni.
